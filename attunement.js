...
// FORMAT 
if (attunementReq == "Does Not Require Attunement") {
  event.value = ""
...
} else if (attunementReq == "Auto" && attunementBy === "Auto Attunement By") {
...
} else if (attunementReq == "Requires Attunement" && attunementBy === "Auto Attunement By") {
...
} else if (attunementBy != "Auto Attunement By") {
